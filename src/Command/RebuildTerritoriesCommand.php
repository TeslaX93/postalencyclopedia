...
class RebuildTerritoriesCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $territories[] = new Territory('Abkhazia', 'Abkhazie', 'Аҧсны', 'Republic of Abkhazia', 'République d\'Abkhazie', 'Аҧсны Аҳәынҭқарра', 0, 1, '', '/($^)/', '', self::RIGHT_ALIGNED_TO_LEFT, null, null, null);
        ...
        $territories[] = new Territory('Artsakh', 'Artsakh', 'Արցախ', 'Republic of Artsakh', 'République d\'Artsakh', 'Արցախի Հանրապետություն', 0, 1, '', '/\\d{4}/', '', self::RIGHT_ALIGNED_TO_LEFT, null, null, null);
        ...
        $territories[] = new Territory('British Antarctic Territory', 'Territoire antarctique britannique', 'British Antarctic Territory', 'British Antarctic Territory', 'Territoire antarctique britannique', 'British Antarctic Territory', 1, 0, '', '/(BIQQ 1ZZ)/', '', self::RIGHT_ALIGNED_TO_LEFT, 'xba', null, null);
        ...
        $territories[] = new Territory('Clipperton Island', 'Île Clipperton', 'Île Clipperton', 'Clipperton Island', 'Île Clipperton', 'Île Clipperton', 1, 0, '', '/(98799)/', '', self::RIGHT_ALIGNED_TO_LEFT, 'cpt', null, null);
        ...
        $territories[] = new Territory('Crimea (with Sevastopol)', 'Crimée', 'Крым', 'Republic of Crimea', 'République de Crimée', 'Республика Крым', 1, 1, '', '/\\d{6}/', '', self::RIGHT_ALIGNED_TO_LEFT, null, null, null);
        ...
        $territories[] = new Territory('Northern Cyprus', 'Chypre du Nord', 'Kuzey Kıbrıs', 'Turkish Republic of Northern Cyprus', 'République turque de Chypre du Nord', 'Kuzey Kıbrıs Türk Cumhuriyeti', 0, 1, '', '/\\d{5}/', '', self::RIGHT_ALIGNED_TO_LEFT, null, null, null);
        ...
        $territories[] = new Territory('Somaliland', 'Somaliland', 'Somaliland', 'Republic of Somaliland', 'République du Somaliland', 'Republic of Somaliland', 0, 1, '', '/($^)/', '', self::RIGHT_ALIGNED_TO_LEFT, null, null, null);
        ...
        $territories[] = new Territory('South Ossetia', 'Ossétie du Sud', 'Хуссар Ирыстон', 'Republic of South Ossetia', 'République d\'Ossétie du Sud-Alanie', 'Республикӕ Хуссар Ирыстон', 0, 1, '', '/($^)/', '', self::RIGHT_ALIGNED_TO_LEFT, null, null, null);
        ...
        $territories[] = new Territory('Transnistria', 'Transnistrie', 'Приднестровье', 'Pridnestrovian Moldavian Republic', 'République moldave du Dniestr', 'Република Молдовеняскэ Нистрянэ', 0, 1, '', '/($^)/', '', self::RIGHT_ALIGNED_TO_LEFT, null, null, null);
